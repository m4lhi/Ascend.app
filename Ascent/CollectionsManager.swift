                ...
                ZStack {
                    ...
                    VStack(spacing: 6) {
                        Image(systemName: "rectangle.stack.fill")
                            .font(DesignSystem.Typography.appFont(size: 30))
                            .foregroundColor(.white)
...
struct CollectionDetailSheet: View {
    ...
    var heroHeader: some View {
        ZStack(alignment: .bottomLeading) {
            ...
            if images.count >= 3 {
                ...
                .overlay(
                    Image(systemName: "mountain.2.fill")
                        .font(DesignSystem.Typography.appFont(size: 50))
            ...
            VStack(alignment: .leading, spacing: 6) {
                if collection.isShared {
                    HStack(spacing: 4) {
                        Image(systemName: "person.2.fill").font(DesignSystem.Typography.appFont(size: 10))
                        Text("SHARED").font(DesignSystem.Typography.appFont(size: 10, weight: .black)).tracking(1)
                    }
                    .foregroundColor(.white.opacity(0.8))
                }

                Text(collection.name)
                    .font(DesignSystem.Typography.appFont(size: 26, weight: .bold))
                    .foregroundColor(.white)
    ...
    func collectionStat(icon: String, value: String, label: String) -> some View {
        VStack(spacing: 4) {
            Image(systemName: icon).font(DesignSystem.Typography.appFont(size: 16)).foregroundColor(accent)
            Text(value).font(DesignSystem.Typography.appFont(size: 15, weight: .bold))
            Text(label).font(DesignSystem.Typography.appFont(size: 10)).foregroundColor(.secondary)
        }
        .frame(maxWidth: .infinity)
    }
