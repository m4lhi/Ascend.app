        ...
        ZStack {
            ...
            VStack(spacing: 25) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("ASCENT")
                        .font(DesignSystem.Typography.appFont(size: 40, weight: .black))
                ...
                HStack {
                    ...
                    Text("OR").font(DesignSystem.Typography.appFont(style: .caption)).foregroundColor(.gray).padding(.horizontal, 10)
                    VStack { Divider().background(Color.gray.opacity(0.5)) }
                }
