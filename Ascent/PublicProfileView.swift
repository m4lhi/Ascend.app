                    ...
                    VStack(spacing: 24) {
                                        ...
                                        Circle()
                                            ...
                                            .overlay(
                                                Text(String(userName.prefix(1)).uppercased())
                                                    .font(DesignSystem.Typography.appFont(size: 36, weight: .bold))
                                ...
                                if !isLoading {
                                    ZStack {
                                        Image(systemName: "hexagon.fill")
                                            .font(DesignSystem.Typography.appFont(size: 38))
                        ...
                        VStack(alignment: .leading, spacing: 14) {
                            HStack {
                                ...
                                Text("Top Achievements").font(DesignSystem.Typography.appFont(size: 14, weight: .bold)).foregroundColor(.secondary).textCase(.uppercase)
                            }
                            .padding(.horizontal, 24)
                        ...
                        VStack(alignment: .leading, spacing: 14) {
                            HStack {
                                ...
                                Text("Equipment Locker").font(DesignSystem.Typography.appFont(size: 14, weight: .bold)).foregroundColor(.secondary).textCase(.uppercase)
                            }
                            .padding(.horizontal, 24)
    ...
    var body: some View {
        VStack(spacing: 8) {
            ZStack {
                ...
                Image(systemName: icon).font(DesignSystem.Typography.appFont(size: 24)).foregroundColor(color)
            }
            Text(title)
