        ...
        if response.status_code == 200:
            ...
            if features:
                ...
                if coords:
                    ...
                    # Extract elevations if they exist, otherwise 0
                    # BRouter returns [lon, lat, elev]
                    elevations = [int(float(c[2])) if len(c) > 2 else 0 for c in coords]
...
def process_mountains():
    ...
    for peak in peaks:
        ...
        route_polyline, route_elevations = fetch_walking_route(trailhead_lon, trailhead_lat, peak_lon, peak_lat)
        ...
        if route_polyline:
            route_data = {
                ...
                "elevation_profile": route_elevations
            }
